...
public class PsychosisVolume : VolumeComponent, IPostProcessComponent
{
    ...
    public ClampedFloatParameter aberrationAmount = new ClampedFloatParameter(0.5f, 0f, 2f); // Increased max range
    public FloatParameter breathingSpeed = new FloatParameter(2.0f); // New param for warping
    ...
    private sealed class PsychosisPass : ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<PassData>("Psychosis Pass", out var passData))
            {
                ...
                passData.breathing = vol.breathingSpeed.value;
                ...
                builder.SetRenderFunc((PassData data, RasterGraphContext ctx) =>
                {
                    ...
                    data.material.SetFloat("_BreathingSpeed", data.breathing);

                    // Blitter handles standard blit
